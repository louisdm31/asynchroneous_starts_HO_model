...
Le prédicat $\mathcal{P}_{fini}(\Phi)$ est une version d'avantage affaiblie de $\Phi$, où $\Phi$ est vérifié avec délai inconnu des processus, et pouvant varier au cours du temps.
