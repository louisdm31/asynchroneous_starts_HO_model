...
For instance, the \emph{ThreePhaseCommit} algorithm for non-blocking atomic commitment~\cite{BHG},
	as well as the consensus algorithms in~\cite{DLS87} or the \emph{LastVoting} algorithm ~\cite{CBS09}
