...
%L'un des principaux problèmes étudié dans la littérature est le problème du consensus, où les processus doivent s'accorder sur une même valeur parmi un ensemble de valeurs possibles.
...
%Un article a été publié afin de contourner cette limitation  Cet article propose un algorithme distribué, qui peut être démarré de manière asynchrones par les nœuds du réseau,
